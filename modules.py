...
class FeatureAttentionLayer(nn.Module):
    ...
    def __init__(self, n_features, window_size, dropout, alpha, embed_dim=None, use_gatv2=True, use_bias=True):
        ...
        if self.use_gatv2:
            ...
            a_input_dim = 2 * self.embed_dim  #embed_dim 线性变换输出维度
    ...
    def forward(self, x):
        ...
        return nn.LayerNorm(self.n_features)(h.permute(0, 2, 1) + x.permute(0, 2, 1))
    ...
    def _make_attention_input(self, v):
        ...
        K = self.num_nodes
        blocks_repeating = v.repeat_interleave(K, dim=1)  # Left-side of the matrix (b,K*K,win)
        blocks_alternating = v.repeat(1, K, 1)  # Right-side of the matrix (b,K*K,win)
...
class TemporalAttentionLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        return nn.LayerNorm(self.n_features)(h + x)
